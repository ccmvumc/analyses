...
# Schaefer200
# Schaefer400
# FS7 Hippocampus Head/Body/Tail
# DnSeg NBM
# FS7 Amygdala
# FS7 Thalamus
...
def get_hemi(df):
    df.loc[df.r1atlas == 'Schaefer100', 'r1hemi'] = df.r1name.str.split('.').str[1].str.split('_').str[1]
    df.loc[df.r2atlas == 'Schaefer100', 'r2hemi'] = df.r2name.str.split('.').str[1].str.split('_').str[1]
    ...
    df.loc[df.r1atlas == 'Schaefer400', 'r1hemi'] = df.r1name.str.split('.').str[1].str.split('_').str[2]
    df.loc[df.r2atlas == 'Schaefer400', 'r2hemi'] = df.r2name.str.split('.').str[1].str.split('_').str[2]
    df.loc[df.r1atlas.isin(['DnSeg_lh', 'HBT_lh']), 'r1hemi'] = 'LH'
    df.loc[df.r2atlas.isin(['DnSeg_lh', 'HBT_lh']), 'r2hemi'] = 'LH'
    df.loc[df.r1atlas.isin(['DnSeg_rh', 'HBT_rh']), 'r1hemi'] = 'RH'
    df.loc[df.r2atlas.isin(['DnSeg_rh', 'HBT_rh']), 'r2hemi'] = 'RH'
    df.loc[df.r1atlas.isin(['networks', 'Hypothal', 'Yeo2011']), 'r1region'] = 'both'
    df.loc[df.r2atlas.isin(['networks', 'Hypothal', 'Yeo2011']), 'r2region'] = 'both'
    df.loc[df.r1atlas.isin(['ThalamicNuclei', 'sclimbic']), 'r1region'] = 'TBD'
    df.loc[df.r2atlas.isin(['ThalamicNuclei', 'sclimbic']), 'r2region'] = 'TBD'
    return df

def get_network(df):
    df.loc[df.r1atlas == 'Schaefer100', 'r1network'] = df.r1name.str.split('.').str[1].str.split('_').str[2]
    df.loc[df.r2atlas == 'Schaefer100', 'r2network'] = df.r2name.str.split('.').str[1].str.split('_').str[2]
    ...
    df.loc[df.r1atlas == 'Schaefer400', 'r1network'] = df.r1name.str.split('.').str[1].str.split('_').str[3]
    df.loc[df.r2atlas == 'Schaefer400', 'r2network'] = df.r2name.str.split('.').str[1].str.split('_').str[3]
    df.loc[df.r1atlas.isin(['HBT_lh', 'HBT_rh', 'Yeo2011', 'ThalamicNuclei', 'sclimbic']), 'r1network'] = df.r1name.str.split('.').str[1]
    df.loc[df.r2atlas.isin(['HBT_lh', 'HBT_rh', 'Yeo2011', 'ThalamicNuclei', 'sclimbic']), 'r2network'] = df.r2name.str.split('.').str[1]
    ...
    df.loc[df.r1atlas.isin(['DnSeg_lh', 'DnSeg_rh', 'Hypothal']), 'r1network'] = df.r1name
    df.loc[df.r2atlas.isin(['DnSeg_lh', 'DnSeg_rh', 'Hypothal']), 'r2network'] = df.r2name
    return df

def get_region(df):
    df.loc[df.r1atlas == 'Schaefer100', 'r1region'] = df.r1name.str.split('.').str[1].str.split('_', n=3).str[3]
    df.loc[df.r2atlas == 'Schaefer100', 'r2region'] = df.r2name.str.split('.').str[1].str.split('_', n=3).str[3]
    ...
    df.loc[df.r1atlas == 'Schaefer400', 'r1region'] = df.r1name.str.split('.').str[1].str.split('_', n=4).str[4]
    df.loc[df.r2atlas == 'Schaefer400', 'r2region'] = df.r2name.str.split('.').str[1].str.split('_', n=4).str[4]   
    df.loc[df.r1atlas.isin(['HBT_lh', 'HBT_rh', 'Yeo2011', 'ThalamicNuclei', 'sclimbic']), 'r1region'] = df.r1name.str.split('.').str[1]
    df.loc[df.r2atlas.isin(['HBT_lh', 'HBT_rh', 'Yeo2011', 'ThalamicNuclei', 'sclimbic']), 'r2region'] = df.r2name.str.split('.').str[1]
    ...
    df.loc[df.r1atlas.isin(['DnSeg_lh', 'DnSeg_rh', 'Hypothal']), 'r1region'] = df.r1name
    df.loc[df.r2atlas.isin(['DnSeg_lh', 'DnSeg_rh', 'Hypothal']), 'r2region'] = df.r2name
    return df


def get_short(df):
    df.loc[df.r1atlas.isin(['Schaefer100', 'Schaefer200', 'Schaefer400']), 'r1'] = df['r1atlas'] + '.' + df['r1hemi'] + '.' + df['r1network'] + '.' + df['r1region']
    df.loc[df.r2atlas.isin(['Schaefer100', 'Schaefer200', 'Schaefer400']), 'r2'] = df['r2atlas'] + '.' + df['r2hemi'] + '.' + df['r2network'] + '.' + df['r2region']
    df.loc[df.r1atlas.isin(['HBT_lh', 'HBT_rh', 'Yeo2011', 'ThalamicNuclei', 'sclimbic']), 'r1'] = df['r1atlas'] + '.' + df['r1region']
    df.loc[df.r2atlas.isin(['HBT_lh', 'HBT_rh', 'Yeo2011', 'ThalamicNuclei', 'sclimbic']), 'r2'] = df['r2atlas'] + '.' + df['r2region']
    df.loc[df.r1atlas.isin(['DnSeg_lh', 'DnSeg_rh', 'Hypothal']), 'r1'] = df.r1name
    df.loc[df.r2atlas.isin(['DnSeg_lh', 'DnSeg_rh', 'Hypothal']), 'r2'] = df.r2name
    return df
