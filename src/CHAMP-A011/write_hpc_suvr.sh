...
for subject in $in_dir/*; do
    ...
    mri_segstats --seg "${subject}/assessors/*/*FEOBVQA_v4*/SUBJ/mri/gtmseg.mgz" --id 17 --i "${subject}/assessors/*/*FEOBVQA_v4*/SUBJ/gtmpvc.output/rbv.nii.gz" --avgwf "${out_dir}/${subject_name}/Left_hpc.txt"
    mri_segstats --seg "${subject}/assessors/*/*FEOBVQA_v4*/SUBJ/mri/gtmseg.mgz" --id 53 --i "${subject}/assessors/*/*FEOBVQA_v4*/SUBJ/gtmpvc.output/rbv.nii.gz" --avgwf "${out_dir}/${subject_name}/Right_hpc.txt"
done
