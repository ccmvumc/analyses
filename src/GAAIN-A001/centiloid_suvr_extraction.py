...
in_dir = '/INPUTS'
###SAVED IN THE 'atlases' FOLDER ON GITHUB
atlas = '/spm8_MNI_avg152T1.nii'
...
# Import gaain masks ###SAVED IN THE 'atlases' FOLDER ON GITHUB
ctx_voi = image.load_img(
	'centiloid_ctx_2mm.nii'
	)

wcbm_voi = image.load_img(
	'/centiloid_WhlCbl_2mm.nii'
	)
