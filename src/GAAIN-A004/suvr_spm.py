...
if not os.path.exists('/Users/jasonrussell/Documents/OUTPUTS/gaain_A004'):
	os.mkdir('/Users/jasonrussell/Documents/OUTPUTS/gaain_A004')
else:
	print('Directory exists, continue')

in_dir = '/Users/jasonrussell/Documents/INPUTS/gaain_A004'
